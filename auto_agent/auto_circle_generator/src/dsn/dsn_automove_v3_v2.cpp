 ...
 * dsn_automove_v3_v2: 2018/11/26 Change the input csv format. Also, may also use planned path for the movement from object to container.
 * 
 *
*/
...
int main(int argc, char **argv)
{
    ...
    if (true) // for future
    {
        ...
        /* --------------------------------------------------- */
            ...
            //inFile1.open("/home/yq/Simulator/mine_ws/planned_path/1/homing_to_object_"+to_string(num_inFile)+".csv");
            inFile1.open("/home/yq/Simulator/mine_ws/planned_path/gaussian/homing_to_object_1_gaussian_"+to_string(num_inFile)+".csv");
            if (!inFile1) {
...
#endif
            // move a little down
            change.tf.translation.x -= 15000;
            change.tf.translation.z -= 5000;
            change.seg_label = 1;
            path.push_back(change);
    ...
    //#define MOVETOCONTAINERMOTION
        ...
        /* --------------------------------------------------- */   
            ...
            /* need to be changed if used in the future*/
            // the last one may be 0 for x
    ...
    #define MOVETOCONTAINERFIXED
            ...
            change.tf.translation.z = 60000 + 40000;
            change.b_tl = true;
            change.seg_label = 4;
            path.push_back(change);
    #endif
