...
int main(int argc, char **argv)
{
    ...
    const Eigen::Affine3d &end_effector_state = kinematic_state->getGlobalLinkTransform("grasper1_L");
    ...
    double timeout = 0.1;
    Eigen::Translation<float, 3> t(-0.12, -0.015, 0);
    //end_effector_state = Eigen::Translation(v);
