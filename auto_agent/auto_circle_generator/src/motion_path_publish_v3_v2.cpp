 ...
 * 20180822: v3_v2: starting positon and goal position are all in cartesian space. The motion planning is also of cartesian space.
 *
*/
...
//#define JOINTSTART
        ...
        start_pose2.position.x = -0.233711;
        start_pose2.position.y = -0.0339789;
        start_pose2.position.z = -0.145832;
...
//#define JointTarget
        ...
        move_group.setPositionTarget(-0.133311, 0.0418326, -0.231198);
#endif

        /*---------------------------------------set planner--------------------------------------------*/
        // FMTkConfigDefault,  PRMkConfigDefault, RRTkConfigDefault, RRTstarkConfigDefault
        if (choice == 1) move_group.setPlannerId("FMT"); // after updating. moveit changes. So use "FMT".
