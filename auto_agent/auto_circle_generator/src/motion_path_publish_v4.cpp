...
{   
    ...
    while (flag) {
        ...
        vector<double> start_jpos = {0.523, 1.577, -0.05, 0, 0};
        /*
        for (int i=0; i<3; ++i) {
            start_jpos[i] = gold_s.jpos[i+arm_flag*3]); //!! left/right arm
        } */
