...
for i in range(1,10): # [1] initial values
    ...
    newLine[grasp_index:grasp_index+2] = [0, 0] # filed.grasp_d
    # filed.envVals
    # filed.current_cmd
    # filed.jpos_d
...
while True:
    ...
    newLine[grasp_index:grasp_index+2] = [0, 0] # firstLineRunlevel3[grasp_index:grasp_index+2] # filed.grasp_d
...
graspSteps = 2000
graspSpacing = float(3 - 0) / graspSteps
print(graspSpacing)
for i in range(1,graspSteps):
    newLine[runlevel_index] = "3"
    last_seq = last_seq + 1
    newLine[packet_index] = str(last_seq)
    newLine[grasp_index:grasp_index+2] = [0+(i*graspSpacing), 0+(i*graspSpacing)]
